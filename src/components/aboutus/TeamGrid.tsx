...
const TeamGrid: React.FC = () => {
  ...
  const teamMembers: TeamMember[] = [
    ...
    { name: "Dr. Teja Simha Reddy Nallapareddi", role: t('about_us.team.member4_role'), description: t('about_us.team.member4_desc'), image: '/images/Dr. Teja Simha Reddy Nallapareddi.jpeg' },
  ];
